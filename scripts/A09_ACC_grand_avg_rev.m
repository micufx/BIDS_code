...
for cond=1 : num_conditions
    ...
    if cond == 1 % 'hit'
        ...
        saveas(acc_fig_rev, [outpath, 'Grand_avg_ACC_rev_hit', '.png']);
        saveas(acc_fig_rev, [outpath, '\\group_analysis\\','Grand_avg_ACC_rev_hit', '.png']);
    ...
    elseif cond == 2 % 'miss'
        ...
        % Save the figure as a PNG image
        saveas(acc_fig_rev, [outpath, 'Grand_avg_ACC_rev_miss', '.png']);
        saveas(acc_fig_rev, [outpath, '\\group_analysis\\','Grand_avg_ACC_rev_miss', '.png']);
    ...
    elseif cond == 3  % % 'none'
        ...
        % Save the figure as a PNG image
        saveas(acc_fig_rev, [outpath, 'Grand_avg_ACC_rev', '.png']);
        saveas(acc_fig_rev, [outpath, '\\group_analysis\\','Grand_avg_ACC_rev', '.png']);
