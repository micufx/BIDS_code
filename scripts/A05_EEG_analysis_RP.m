...
for sub = 1 : length(files)
    ...
    saveas(gcf, [out_subfold, 'ERPs_comparison_RP_', participant, '.png']); % Save the figure as a PNG image
    saveas(gcf, [outpath, '\\group_analysis\\','ERPs_comparison_RP_', participant, '.png']); % Save the figure as a PNG image
