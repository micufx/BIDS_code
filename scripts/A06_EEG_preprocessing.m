...
for sub = 1 : length(files)
    ...
    saveas(gcf , [out_subfold, 'All_ICA_', participant, '.png']); % Saving components
    saveas(gcf, [outpath, '\\group_analysis\\','All_ICA_', participant, '.png']); % Save the figure as a PNG image
